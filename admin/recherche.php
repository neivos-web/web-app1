...
<head>
    ...
    <title>Outsiders - Recherche</title>
    ...
    <main>
        ...
        <section class="relative bg-white">
            <div class="absolute inset-0">
                ...
                <img src="images/ar_mr_banner.jpg" class="w-full h-full object-cover opacity-80" alt="Workspace" data-editable>
                <div class="absolute inset-0 bg-black opacity-40"></div>
            </div>
            <div class="relative container mx-auto px-6 py-24 md:py-32 text-center text-white">
                <button class="edit-btn text-xs">✎</button>
                <h1 class="text-3xl md:text-5xl font-extrabold mb-4" data-editable>Bienvenue dans notre section Inclusion et Recherche</h1>
                <button class="edit-btn text-xs">✎</button>
                <p class="text-lg max-w-3xl mx-auto" data-editable>Découvrez les dernières nouvelles recherches illustrant notre vision et nos derniers progrès réalisés.</p>
            </div>
        </section>
