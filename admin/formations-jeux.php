...
<head>
    ...
    <title>Outsiders - Formations Jeux Vidéo</title>
...
<body class="bg-gray-100 text-brand-dark">
    ...
    <main>
        ...
        <div class="banner-container">
            <h2>Formation Jeux Vidéo</h2>
            <p>
                Plongez dans l’univers du jeu vidéo et donnez vie à vos créations numériques !
            </p>
        </div>
        </section>
        ...
        <div class="formation-container">
            ...
            <h2>Formation Jeux Vidéo : Créez vos mondes interactifs</h2>
            <p>
               Apprenez à <strong>concevoir, développer et optimiser vos jeux vidéo</strong> grâce à nos cours pratiques et immersifs.
               Développez vos compétences en design, programmation et gameplay, et transformez vos idées en expériences interactives captivantes.
            </p>

            <h3>Points forts :</h3>
            <ul class="formation-points">
                <li><i class="bi bi-check2"></i> Création et design de niveaux et personnages</li>
                <li><i class="bi bi-check2"></i> Programmation et mécaniques de gameplay</li>
                <li><i class="bi bi-check2"></i> Utilisation de casques Vive Focus ou Meta Quest 3</li>
                <li><i class="bi bi-check2"></i> Projets pratiques et ateliers créatifs</li>
            </ul>
            </div>

            <div class="formation-image">
            <img src="images/jeux.jpg" alt="Icône Description" />
            </div>
        </div>
        </section>
