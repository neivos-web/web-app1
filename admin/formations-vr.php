...
<head>
    ...
    <title>Outsiders - Formations VR</title>
...
<body class="bg-gray-100 text-brand-dark">
    ...
    <main>
        ...
        <div class="banner-container">
            <h2>Formations Modèles 3D en VR (casque)</h2>
            <p>
            Découvrez nos cours de RV passionnants ! Encouragez la compréhension
            technique et la créativité avec casque.
            </p>
        </div>
        </section>
        ...
        <div class="formation-container">
            ...
            <h2>Formation à l'importation et à la visualisation de modèles 3D en VR (casque)</h2>
            <p>
                Apprenez à importer, visualiser et optimiser vos modèles 3D dans des environnements VR immersifs.
                Grâce à nos cours interactifs pour casque VR, développez vos compétences techniques tout en stimulant votre créativité.
            </p>

            <h3>Points forts :</h3>
            <ul class="formation-points">
                <li><i class="bi bi-check2"></i> Importation et optimisation de modèles 3D</li>
                <li><i class="bi bi-check2"></i> Création de scènes VR interactives</li>
                <li><i class="bi bi-check2"></i> Utilisation de casques Vive Focus ou Meta Quest 3</li>
                <li><i class="bi bi-check2"></i> Exercices pratiques et projets concrets</li>
            </ul>
            </div>

            <div class="formation-image">
            <img src="images/vr.jpg" alt="Icône Description" />
            </div>
        </div>
        </section>
