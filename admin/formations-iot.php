...
<head>
    ...
    <title>Outsiders - Formations Systèmes Embarqués & IOT</title>
    ...
    <main>
        ...
        <section class="relative bg-white">
            <div class="absolute inset-0">
                <img src="images/vr_banner.jpg" alt="Image de fond VR" class="w-full h-full object-cover">
                <div class="absolute inset-0 bg-black opacity-40"></div>
            </div>
            <div class="relative container mx-auto px-6 py-24 md:py-32 text-center text-white">
                <h1 class="text-3xl md:text-5xl font-extrabold mb-4">Explorez l'univers de nos formations et laissez-vous surprendre par la diversité de nos créations. </h1>
                <p class="text-lg max-w-3xl mx-auto">Parcourrir nos traveaux ! Peut-être y trouverez-vous l'étincelle pour votre prochain projet ? Nous l'espérons sincèrement !</p>
            </div>
        </section>
        ...
        <div class="banner-container">
            <h2>Formation Systèmes Embarqués & IoT</h2>
            <p>
            Découvrez nos formations fystèmes embarqués & IoT passionnants ! Encouragez la compréhension
            technique et la créativité en IOT
            </p>
        </div>
        </section>
        ...
        <div class="formation-container">
            ...
            <h2>Plongez dans l’univers de l’IoT et transformez vos idées en objets connectés fonctionnels !</h2>
            <p>
                Apprenez à <strong>concevoir, programmer et connecter</strong> des objets intelligents grâce à nos cours pratiques et interactifs.
                Développez vos compétences en électronique, microcontrôleurs et communication IoT pour créer des solutions innovantes et connectées.
            </p>

            <h3>Points forts :</h3>
            <ul class="formation-points">
                <li><i class="bi bi-check2"></i> Programmation de microcontrôleurs et capteurs</li>
                <li><i class="bi bi-check2"></i> Développement de systèmes embarqués fiables</li>
                <li><i class="bi bi-check2"></i> Intégration et communication IoT sécurisée</li>
                <li><i class="bi bi-check2"></i> Projets pratiques et applications concrètes</li>
            </ul>
            </div>

            <div class="formation-image">
            <img src="images/iot.jpg" alt="Icône Description" />
            </div>
        </div>
        </section>
