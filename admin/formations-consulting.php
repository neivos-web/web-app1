...
<head>
    ...
    <title>Outsiders - Consulting & Accompagnement IT</title>
    ...
    <main>
        ...
        <section class="relative bg-white">
            ...
            <div class="relative container mx-auto px-6 py-24 md:py-32 text-center text-white">
                <button class="edit-btn">✎</button>
                <h1 class="text-3xl md:text-5xl font-extrabold mb-4" data-editable>Explorez l'univers de nos formations et laissez-vous surprendre par la diversité de nos créations. </h1>
                <button class="edit-btn">✎</button>
        ...
        <!-- Section Bannière Formation -->
        <section class="formation-banner">
        <div class="banner-container">
            <button class="edit-btn">✎</button>
            <h2 data-editable>Consulting et Accompagnement IT</h2>
            <button class="edit-btn">✎</button>
            <p data-editable>
                Transformez vos challenges IT en opportunités grâce à un accompagnement expert et personnalisé !
            </p>
        </div>
        </section>
        ...
        <div class="formation-container">
            ...
            <button class="edit-btn">✎</button>
            <h2 data-editable>Transformez vos challenges IT en opportunités grâce à un accompagnement expert et personnalisé !</h2>
            <button class="edit-btn">✎</button>
            <p data-editable>
                Bénéficiez de notre expertise pour optimiser vos systèmes, sécuriser vos infrastructures et réussir vos projets numériques.
                Nous vous accompagnons à chaque étape, de l’audit à la mise en œuvre, pour des solutions IT efficaces et sur-mesure.
            </p>
            
            <ul class="formation-points">        
                <button class="edit-btn">✎</button><li data-editable><i class="bi bi-check2" data-editable><button class="edit-btn">✎</button></i> Analyse et optimisation des systèmes informatiques</li>
                <button class="edit-btn">✎</button><li data-editable><i class="bi bi-check2" data-editable><button class="edit-btn">✎</button></i> Sécurité et gestion des infrastructures</li>
                <button class="edit-btn">✎</button><li data-editable><i class="bi bi-check2" data-editable><button class="edit-btn">✎</button></i> Conseil stratégique et accompagnement projet</li>
                <button class="edit-btn">✎</button><li data-editable><i class="bi bi-check2" data-editable><button class="edit-btn">✎</button></i> Solutions adaptées aux besoins spécifiques de votre entreprise</li>
            </ul>
            </div>

            <div class="formation-image">
                <button class="edit-btn">✎</button>
            <img src="images/consulting.jpg" alt="Icône Description" data-editable/>
            </div>
        </div>
        </section>
