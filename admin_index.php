...
<header class="bg-white shadow-sm sticky top-0 z-50">
  <nav class="container mx-auto px-6 py-4 flex justify-between items-center relative">
    ...
    <!-- Main menu -->
    <div id="menu"
         class="hidden md:flex flex-col md:flex-row md:items-center space-y-4 md:space-y-0 md:space-x-8 font-medium text-gray-700 absolute md:relative top-full left-0 w-full md:w-auto bg-white md:bg-transparent shadow-md md:shadow-none p-4 md:p-0 max-h-96 overflow-y-auto">
      ...
      <div data-editable data-key="nav_mission" class="flex items-center space-x-2">
        ...
        <button class="edit-btn" aria-label="Edit Mission">✎</button>
      </div>
      ...
      <div class="relative group" data-key="nav_news">
        <div class="flex items-center space-x-2">
          <a href="#" class="flex items-center text-brand-blue font-semibold" data-role="menu-toggle">
            Actualités / Blog
            <svg class="w-4 h-4 ml-1 transition-transform duration-200 group-hover:rotate-180" fill="currentColor" viewBox="0 0 20 20">
              <path fill-rule="evenodd" d="M5.23 7.21a.75.75 0 011.06.02L10 10.94l3.71-3.71a.75.75 0 111.08 1.04l-4.25 4.25a.75.75 0 01-1.08 0L5.21 8.27a.75.75 0 01.02-1.06z" clip-rule="evenodd"/>
            </svg>
        ...
        <div class="absolute left-1/2 transform -translate-x-1/2 mt-2 w-44 rounded-md shadow-lg bg-white z-20 hidden group-hover:block">
          <div class="py-1">
            <div class="flex justify-between items-center px-2">
