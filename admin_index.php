  ...
  <header class="bg-white shadow-sm sticky top-0 z-50">
    <nav class="container mx-auto max-w-full px-20 py-6 flex justify-between items-center gap-10">
            ...
            <div class="flex items-center space-x-4">
                ...
                <a href="index.html" class="flex items-center space-x-5">
                    <img src="images/logo.png" alt="Outsiders Logo" class="h-10 w-auto object-contain" data-editable>
                    <span class="text-2xl font-bold text-gray-900 hover:text-brand-blue" data-editable>Outsiders</span>
                </a>
            </div>
            <div class="hidden md:flex space-x-5 items-center font-medium text-gray-700">
                <div class="nav-item-wrapper">
                    
                    <a href="mission.html" class="hover:text-brand-blue" data-editable>Mission et Vision</a>
                </div>
                <div class="relative nav-item-wrapper">
                

                <!-- Main button -->
                <button 
                    id="dropdownButtonPortefeuille"  class="flex items-center hover:text-brand-blue focus:outline-none" data-editable>
                    Portefeuille
                ...
                <div id="dropdownMenuPortefeuille" class="absolute top-full left-0 hidden bg-white shadow-xl rounded-lg w-64 text-center z-20 mt-2 transition-all duration-200">
                    ...
                    <div class="flex justify-between items-center px-4 py-2 hover:bg-gray-100 hover:text-brand-blue">
                    <a href="portfeuille.html#gaming" data-editable>Jeux Video</a>
                    <button class="edit-btn text-xs">✎</button>
                    </div>
                    <div class="flex justify-between items-center px-4 py-2 hover:bg-gray-100 hover:text-brand-blue">
                    <a href="portfeuille.html#cad" data-editable>AR/MR</a>
                    <button class="edit-btn text-xs">✎</button>
                    </div>
                    <div class="flex justify-between items-center px-4 py-2 hover:bg-gray-100 hover:text-brand-blue">
                    <a href="portfeuille.html#ar-mr" data-editable>AR/MR</a>
                    <button class="edit-btn text-xs">✎</button>
                    </div>
                    <div class="flex justify-between items-center px-4 py-2 hover:bg-gray-100 hover:text-brand-blue">
                    <a href="portfeuille.html#vr" data-editable>VR</a>
                    <button class="edit-btn text-xs">✎</button>
                    </div>
                    <div class="flex justify-between items-center px-4 py-2 hover:bg-gray-100 hover:text-brand-blue">
                    <a href="portfeuille.html#ia" data-editable>CAD</a>
                    <button class="edit-btn text-xs">✎</button>
                    </div>
                ...
                <div class="nav-item-wrapper">
                    ...
                    <a href="simulateurs.html" class="hover:text-brand-blue" data-editable>Simulateurs</a>
                </div>
                <div class="relative nav-item-wrapper">
                

                <!-- Main toggle button -->
                <button id="dropdownButtonFormations" class="flex items-center hover:text-brand-blue focus:outline-none px-3 py-2" data-editable>
                    Formations & conseils
                ...
                <!-- Dropdown menu -->
                <div id="dropdownMenuFormations"
                    class="absolute top-full left-0 hidden bg-white shadow-xl rounded-lg w-64 text-center z-20 mt-2 transition-all duration-200">


                    <div class="flex justify-between items-center px-4 py-2 hover:bg-gray-100 hover:text-brand-blue">
                    <a href="formations.html#vr" data-editable>VR</a>
                    <button class="edit-btn text-xs">✎</button>
                    </div>

                    <div class="flex justify-between items-center px-4 py-2 hover:bg-gray-100 hover:text-brand-blue">
                    <a href="formations.html#processus" data-editable>Jeux Vidéo</a>
                    <button class="edit-btn text-xs">✎</button>
                    </div>
                    <div class="flex justify-between items-center px-4 py-2 hover:bg-gray-100 hover:text-brand-blue">
                    <a href="formations.html#etude" data-editable>Systèmes Embarquée & IOT</a>
                    <button class="edit-btn text-xs">✎</button>
                    </div>
                    <div class="flex justify-between items-center px-4 py-2 hover:bg-gray-100 hover:text-brand-blue">
                    <a href="formations.html#autisme" data-editable>Consulting et accompagnements IT</a>
                    <button class="edit-btn text-xs">✎</button>
                    </div>
                ...
                <div class="relative nav-item-wrapper">
                    ...
                    <!-- Main toggle button -->
                    <button id="dropdownButtonBlog" 
                            class="flex items-center hover:text-brand-blue focus:outline-none px-3 py-2 font-semibold text-brand-blue" 
                            data-editable>
                        Actualités / Blog
                        <svg class="w-4 h-4 ml-1 transition-transform duration-200"
                            fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <!-- Dropdown menu -->
                    <div id="dropdownMenuBlog" class="absolute top-full left-0 hidden bg-white shadow-xl rounded-lg w-64 text-center z-20 mt-2 transition-all duration-200">
                        <div class="flex justify-between items-center px-4 py-2 hover:bg-gray-100 hover:text-brand-blue">
                        <a href="actualites.html" data-editable>Actualités</a>
                        <button class="edit-btn text-xs">✎</button>
                        </div>
                    </div>
                </div>
    ...
    <footer class="site-footer">
        <div class="footer-container">
            ...
            <div class="footer-logo">
                <img src="images/logo.png" alt="Logo du site" data-editable>
            </div>
            
            <p class="footer-text" data-editable>Vous avez des questions ? <span>Contactez-nous</span> — nous sommes à votre disposition.</p>
            
            <a href="contact.html" class="footer-btn" data-editable>Contactez-nous !</a>
        </div>
    </footer>
