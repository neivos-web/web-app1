...
<body class="bg-gray-100 text-brand-dark">
  ...
  <header class="bg-white shadow-sm sticky top-0 z-50">
    <nav class="container mx-auto max-w-full px-20 py-6 flex justify-between items-center gap-10">
            ...
            <div class="flex items-center space-x-4" id="logo_image">
                <button class="edit-btn">✎</button>
                <a href="admin_index.html" class="flex items-center space-x-5">
                    <img src="images/logo_noir.png" alt="Outsiders Logo" class="h-10 w-auto object-contain" data-editable>
                </a>
            </div>
            <div class="hidden md:flex space-x-5 items-center font-medium text-gray-700">
                ...
                <div class="relative nav-item-wrapper">
                    ...
                    <div id="dropdownMenuPortefeuille" class="absolute top-full left-0 hidden bg-white shadow-xl rounded-lg w-64 text-center z-20 mt-2 transition-all duration-200">
                        ...
                        <div class="flex justify-between items-center px-4 py-2 hover:bg-gray-100 hover:text-brand-blue">
                            <a href="portefeuille-jeux.html" data-editable>Jeux Video</a>
                        </div>

                        <div class="flex justify-between items-center px-4 py-2 hover:bg-gray-100 hover:text-brand-blue">
                            <a href="portefeuille-ar.html" data-editable>AR/MR</a>
                        </div>
                        
                        <div class="flex justify-between items-center px-4 py-2 hover:bg-gray-100 hover:text-brand-blue">
                            <a href="portefeuille-vr.html" data-editable>VR</a>
                        </div>

                        <div class="flex justify-between items-center px-4 py-2 hover:bg-gray-100 hover:text-brand-blue">
                            <a href="portefeuille-cao.html" data-editable>CAD</a>
                        </div>
                ...
                <div id="dropdownMenuFormations"
                    ...
                    <div class="flex justify-between items-center px-4 py-2 hover:bg-gray-100 hover:text-brand-blue">
                        <a href="formations-vr.html" data-editable>VR</a>
                    </div>

                    <div class="flex justify-between items-center px-4 py-2 hover:bg-gray-100 hover:text-brand-blue">
                        <a href="formations-jeux.html" data-editable>Jeux Vidéo</a>
                    </div>
                    <div class="flex justify-between items-center px-4 py-2 hover:bg-gray-100 hover:text-brand-blue">
                        <a href="formations-iot.html" data-editable>Systèmes Embarquée & IOT</a>
                    </div>

                    <div class="flex justify-between items-center px-4 py-2 hover:bg-gray-100 hover:text-brand-blue">
                        <a href="formations-consulting.html" data-editable>Consulting et accompagnements IT</a>
                    </div>
