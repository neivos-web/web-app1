...
@section('content')
    ...
    <section class="pxa_pages">
        <div class="pxa_container">
            ...
            <ul>
                <li>
                    <p class="text-justify">Explanation of the purpose of the terms and conditions. It is a long established fact that a
                ...
                <li>
                    <p class="">Definition of key terms used throughout the document. It is a long established fact that a reader
            ...
            <ul>
                <li>
                    <p class="">Explanation of how users accept the terms (e.g., by using the website or service). It is a long
                ...
                <li>
                    <p>Details on the age requirement for users. It is a long established fact that a reader will be
            ...
            <ul>
                <li>
                    <p>Information on the registration process. It is a long established fact that a reader will be
                        distracted by the readable content of a page when looking at its layout. The point of using
                        Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using
                        'Content here, content here', making it look like readable English. Many desktop publishing
                        packages and web page editors now use Lorem Ipsum as their default model text, and a search for
                ...
                <li>
                    <p>Responsibilities of users regarding account information. It is a long established fact that a
                        reader will be distracted by the readable content of a page when looking at its layout. The
                        point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as
                        opposed to using 'Content here, content here', making it look like readable English. Many
                        desktop publishing packages and web page editors now use Lorem Ipsum as their default model
            ...
            <ul>
                <li>
                    <p class="">Description of the services provided. It is a long established fact that a reader will be
                        distracted by the readable content of a page when looking at its layout. The point of using
                        Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using
                        'Content here, content here', making it look like readable English. Many desktop publishing
                        packages and web page editors now use Lorem Ipsum as their default model text, and a search for
                ...
                <li>
                    <p class="">Acceptable use policy. It is a long established fact that a reader will be distracted by the
            ...
            <ul>
                <li>
                    <p class="">User-generated content guidelines. It is a long established fact that a reader will be distracted
                ...
                <li>
                    <p class="">Intellectual property rights. It is a long established fact that a reader will be distracted by
